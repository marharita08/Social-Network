...
export const getNews = async (user_id, page, limit) => {
    return apiClient.get(`/articles/news/${user_id}?page=${page}&limit=${limit}`);
}
...
export const getCountOfNews = async (user_id) => {
    return apiClient.get(`/articles/news/amount/${user_id}`);
}
